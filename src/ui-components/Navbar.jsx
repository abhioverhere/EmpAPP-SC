      ...
      <AppBar position="static" style={{backgroundColor:'rgba(45, 173, 0, 1)'}}>
        <Toolbar>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            <Link to={'/EmpAPP'} style={{color: 'white', textDecoration:'none'}}>Employee Cred App</Link>
          </Typography>
          <Button color="inherit"><Link to={'/EmpAPP'} style={{color: 'white', textDecoration:'none'}}>Home</Link></Button>
